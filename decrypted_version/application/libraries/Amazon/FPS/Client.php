...
require_once (APPPATH.'libraries/Amazon/FPS/Interface.php');
...
class Amazon_FPS_Client implements Amazon_FPS_Interface
{
    ...
    /** @var string */
    private  $_awsAccessKeyId = 'AKIAJHRGJTWJ6TZAYFRA';

    /** @var string */
    private  $_awsSecretAccessKey = 'mGEiblOo7xnZYOPlWHnmoo3/p5MRhicQBFm4CZ/X';
...
*/
    ...
    public function cancelToken($request)
    {
        if (!$request instanceof Amazon_FPS_Model_CancelTokenRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/CancelTokenRequest.php');
            $request = new Amazon_FPS_Model_CancelTokenRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/CancelTokenResponse.php');
    ...
    public function cancel($request)
    {
        if (!$request instanceof Amazon_FPS_Model_CancelRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/CancelRequest.php');
            $request = new Amazon_FPS_Model_CancelRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/CancelResponse.php');
    ...
    public function fundPrepaid($request)
    {
        if (!$request instanceof Amazon_FPS_Model_FundPrepaidRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/FundPrepaidRequest.php');
            $request = new Amazon_FPS_Model_FundPrepaidRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/FundPrepaidResponse.php');
    ...
    public function getAccountActivity($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetAccountActivityRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetAccountActivityRequest.php');
            $request = new Amazon_FPS_Model_GetAccountActivityRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetAccountActivityResponse.php');
    ...
    public function getAccountBalance($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetAccountBalanceRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetAccountBalanceRequest.php');
            $request = new Amazon_FPS_Model_GetAccountBalanceRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetAccountBalanceResponse.php');
    ...
    public function getTransactionsForSubscription($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetTransactionsForSubscriptionRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTransactionsForSubscriptionRequest.php');
            $request = new Amazon_FPS_Model_GetTransactionsForSubscriptionRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTransactionsForSubscriptionResponse.php');
    ...
    public function getSubscriptionDetails($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetSubscriptionDetailsRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetSubscriptionDetailsRequest.php');
            $request = new Amazon_FPS_Model_GetSubscriptionDetailsRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetSubscriptionDetailsResponse.php');
    ...
    public function getDebtBalance($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetDebtBalanceRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetDebtBalanceRequest.php');
            $request = new Amazon_FPS_Model_GetDebtBalanceRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetDebtBalanceResponse.php');
    ...
    public function getOutstandingDebtBalance($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetOutstandingDebtBalanceRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetOutstandingDebtBalanceRequest.php');
            $request = new Amazon_FPS_Model_GetOutstandingDebtBalanceRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetOutstandingDebtBalanceResponse.php');
    ...
    public function getPrepaidBalance($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetPrepaidBalanceRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetPrepaidBalanceRequest.php');
            $request = new Amazon_FPS_Model_GetPrepaidBalanceRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetPrepaidBalanceResponse.php');
    ...
    public function getTokenByCaller($request)
    {
        ...
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTokenByCallerResponse.php');
    ...
    public function cancelSubscriptionAndRefund($request)
    {
        if (!$request instanceof Amazon_FPS_Model_CancelSubscriptionAndRefundRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/CancelSubscriptionAndRefundRequest.php');
            $request = new Amazon_FPS_Model_CancelSubscriptionAndRefundRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/CancelSubscriptionAndRefundResponse.php');
    ...
    public function getTokenUsage($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetTokenUsageRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTokenUsageRequest.php');
            $request = new Amazon_FPS_Model_GetTokenUsageRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTokenUsageResponse.php');
    ...
    public function getTokens($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetTokensRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTokensRequest.php');
            $request = new Amazon_FPS_Model_GetTokensRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTokensResponse.php');
    ...
    public function getTotalPrepaidLiability($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetTotalPrepaidLiabilityRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTotalPrepaidLiabilityRequest.php');
            $request = new Amazon_FPS_Model_GetTotalPrepaidLiabilityRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTotalPrepaidLiabilityResponse.php');
    ...
    public function getTransaction($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetTransactionRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTransactionRequest.php');
            $request = new Amazon_FPS_Model_GetTransactionRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTransactionResponse.php');
    ...
    public function getTransactionStatus($request)
    {
        ...
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetTransactionStatusResponse.php');
    ...
    public function getPaymentInstruction($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetPaymentInstructionRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetPaymentInstructionRequest.php');
            $request = new Amazon_FPS_Model_GetPaymentInstructionRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetPaymentInstructionResponse.php');
    ...
    public function installPaymentInstruction($request)
    {
        if (!$request instanceof Amazon_FPS_Model_InstallPaymentInstructionRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/InstallPaymentInstructionRequest.php');
            $request = new Amazon_FPS_Model_InstallPaymentInstructionRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/InstallPaymentInstructionResponse.php');
    ...
    public function pay($request)
    {
	   ...
	   if (!$request instanceof Amazon_FPS_Model_PayRequest) {
        ...
        require_once (APPPATH.'libraries/Amazon/FPS/Model/PayResponse.php');
        return $this->_invoke($this->_convertPay($request));
    }
    ...
    public function refund($request)
    {
        if (!$request instanceof Amazon_FPS_Model_RefundRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/RefundRequest.php');
            $request = new Amazon_FPS_Model_RefundRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/RefundResponse.php');
    ...
    public function reserve($request)
    {
        if (!$request instanceof Amazon_FPS_Model_ReserveRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/ReserveRequest.php');
            $request = new Amazon_FPS_Model_ReserveRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/ReserveResponse.php');
    ...
    public function settle($request)
    {
        if (!$request instanceof Amazon_FPS_Model_SettleRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/SettleRequest.php');
            $request = new Amazon_FPS_Model_SettleRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/SettleResponse.php');
    ...
    public function settleDebt($request)
    {
        if (!$request instanceof Amazon_FPS_Model_SettleDebtRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/SettleDebtRequest.php');
            $request = new Amazon_FPS_Model_SettleDebtRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/SettleDebtResponse.php');
    ...
    public function writeOffDebt($request)
    {
        if (!$request instanceof Amazon_FPS_Model_WriteOffDebtRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/WriteOffDebtRequest.php');
            $request = new Amazon_FPS_Model_WriteOffDebtRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/WriteOffDebtResponse.php');
    ...
    public function getRecipientVerificationStatus($request)
    {
        if (!$request instanceof Amazon_FPS_Model_GetRecipientVerificationStatusRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/GetRecipientVerificationStatusRequest.php');
            $request = new Amazon_FPS_Model_GetRecipientVerificationStatusRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/GetRecipientVerificationStatusResponse.php');
    ...
    public function verifySignature($request)
    {
        if (!$request instanceof Amazon_FPS_Model_VerifySignatureRequest) {
            require_once (APPPATH.'libraries/Amazon/FPS/Model/VerifySignatureRequest.php');
            $request = new Amazon_FPS_Model_VerifySignatureRequest($request);
        }
        require_once (APPPATH.'libraries/Amazon/FPS/Model/VerifySignatureResponse.php');
      ...
      /*  try {
            ...
            do {
                ...
                /// Rethrow on deserializer error 
                    ...
                    require_once (APPPATH.'libraries/Amazon/FPS/Exception.php');
...
//echo $page;
	  ...
	  //open connection
		...
		curl_setopt($ch,CURLOPT_URL,$fpsServiceEndPoint);
		curl_setopt($ch,CURLOPT_POST,count(explode("&",$query)));
		...
		//close connection
		curl_close($ch);
		//$googleresult = simplexml_load_string($response);//echo var_dump($googleresult);
		//echo "Status: ".$googleresult->Errors->Error->Code."\n";
		//exit;
...
echo var_dump($response);
    ...
    private function _addRequiredParameters(array $parameters)
    {
		...
		//echo $this->_awsSecretAccessKey."<br>-". $parameters['AWSAccessKeyId'];
    ...
    private function _signParameters(array $parameters, $key) {
		...
		//echo "<br>================<br>".$stringToSign."-". $key.":-:".$algorithm."<br>=====================<br>";
