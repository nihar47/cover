...
class Amazon_FPS_CBUIRecipientTokenPipeline extends Amazon_FPS_CBUIPipeline {
     ...
     */
    function Amazon_FPS_CBUIRecipientTokenPipeline($awsAccessKey, $awsSecretKey, $CBUI_URL) {
        parent::Amazon_FPS_CBUIPipeline("Recipient", $awsAccessKey, $awsSecretKey, $CBUI_URL);
    }
