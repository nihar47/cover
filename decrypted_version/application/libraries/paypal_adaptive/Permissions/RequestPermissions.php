...
<div id="request_form">
 	...
 	<form name="Form1" id="Form1" method="post" action="RequestPermissionsReceipt.php">
        ...
        <table>
           ...
           <tr>
				<td class="thinfield" width="120"><a href= "" style="text-decoration:none" onmouseover="ShowContent('Callback'); return true;"onmouseout="HideContent('Callback'); return true;"href="javascript:ShowContent('Callback')">Callback:</a>
					<div id="Callback" style="display:none; position:absolute; border-style: solid; background-color: white; padding: 20px;">Return URL</div>
				</td>
				<td align="left">
            ...
            <tr>
				<td class="thinfield" width="120"><a href= "" style="text-decoration:none" onmouseover="ShowContent('Scope'); return true;"onmouseout="HideContent('Scope'); return true;"href="javascript:ShowContent('Scope')">Scope:</a>
					<div id="Scope" style="display:none; position:absolute; border-style: solid; background-color: white; padding: 20px;">The Source identifies which APIs permissions has to be given</div>
				</td>
				<td align="left">
