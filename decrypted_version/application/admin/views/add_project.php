	...
	$(function() {
		...
		$( "#slider-range-max" ).slider({
			...
			slide: function( event, ui ) {
				...
				document.getElementById('td').value=ui.value;
  ...
  <div id="text">
    <div class="wrapper" style="min-height:540px; ">
      <?php if($error != "")
				...
				{ ?>
      <div align="center" class="error" style="  height:auto; background-color:#FF9191; border:1px solid #FF0000;"> <?php echo $error; ?> </div>
      <?php } ?>
      ...
      <div style="float:left;">
        <div id="cur_tab">1. Get Started</div>
      </div>
...
/*foreach ($categorylist as $row){
	echo "<pre>"; print_r($row['project_category_name']);
	if(isset($row['children'])){
		foreach($row['children'] as $r){
			echo "<pre>&nbsp;&nbsp;".$r['project_category_name'];
			}
		}
	}
echo $category_id;	
...
?>
            ...
            <div class="form-element-container">
              ...
              <input type="radio" name="user_type" id="user_type" value="admin" <?php if($user_type=='admin') { ?> checked <?php } ?> onclick="change_userlist(this.value)" />
              Admin Project
              
              &nbsp;&nbsp;
              <input type="radio" name="user_type" id="user_type" value="user" <?php if($user_type=='user') { ?> checked <?php } ?>  onclick="change_userlist(this.value)" />
              User Project </div>
            <div style="clear:both; height:5px;"></div>
            ...
            <div class="form-element-container">
              ...
              <textarea name="project_summary" id="project_summary" class="btn_textarea" onKeyDown="limitText(this.form.project_summary,this.form.countdown,120);" onKeyUp="limitText(this.form.project_summary,this.form.countdown,120);" ><?php echo $project_summary; ?></textarea>
              <br/>
              <div style=" clear:both;margin-left:150px;" ><font style="font-size:12px;">(Maximum characters: 95)
                
                
                
                You have
                <input readonly type="text" name="countdown" value="95" class="normal_label" style="border:none; width:15px;">
        ...
        <div id="step2" class="div" style="display:none;">
          <div class="inner_content_two">
            <div class="form-element-container">
              ...
              <div style="width:300px; float:left">
                ...
                <span id="total_days"  style="border:0;background:none; display:inline-block; margin-top:5px;"/>0 DAYS</span>
                <input type="hidden" name="total_days" id="td" />
              </div>
            </div>
            <div class="clear"></div>
            <br />
          ...
          <div class="inner_content_two">
            <div class="form-element-container">
              ...
              <div id="test" class="gmap3" style="margin:5px 0 5px 150px;"></div>
              <div style="clear:both;"></div>
        ...
        <div id="step4" class="div" style="display:none;"> 
          ...
          <div class="inner_content_two" id="thirdparty"  style="display:none;">
            <div class="form-element-container">
              ...
              <br/>
              <div style=" clear:both;margin-left:150px;" >Paste the Full Video Page URL for your 3rd party video here.<br/>
          ...
          <div class="inner_content_two" id="custom_video" style="display:none;" >
            <div class="form-element-container">
              ...
              <br/>
              <div style=" clear:both;margin-left:150px;">You can upload a custom video here.<br/>
                <b>Or</b> For 3rd Party Video <span onclick="thirdpartyvideo()" style="font-weight:bold; cursor:pointer; color:#009900;">Click here</span>. </div>
            </div>
          </div>
          ...
          <div id="add_more">
            <div id="more" class="inner_content_two"> 
              ...
              <div class="form-element-container">
                ...
                <div class="dp">
                  <input type="text" name="est_date[]" class="prjtitlediv" style=" width:205px; margin:0px 0 0 5px;" value="<?php //echo date('m-d-Y',strtotime($prk->perk_delivery_date));?>"/>
                </div>
              </div>
              <div class="form-element-container">
                <div class="form-label">
