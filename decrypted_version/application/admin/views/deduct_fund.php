							  ...
							  <div align="center">
								<div id="add-deal">
								  <?php
									...
									echo form_open('set_fund/deduct_fund/'.$userid,$attributes);
								  ?>
									<fieldset class="step">
                                    <div class="fleft">
									  <label>Available Balance(<?php echo $site_setting['currency_symbol'];?>)<span>&nbsp;</span></label>
									  <span >
									  <input type="text" name="balance" id="balance" value="<?php echo $amount;?>" readonly style="background:none; border:none;" />
									  </span>
									</div>
									<div style="clear:both;"></div>
									<div class="fleft">
									  <label>Deduct Fund(<?php echo $site_setting['currency_symbol'];?>)<span>&nbsp;</span></label>
									  <span onmouseover="show_bg('deduct_fund')" onmouseout="hide_bg('deduct_fund')">
									  <input type="text" name="deduct_fund" id="deduct_fund" value="" onfocus="show_bg('deduct_fund')" onblur="hide_bg('deduct_fund')"/>
									  </span>
									</div>
									<div style="clear:both;"></div>
									<div class="fleft">
