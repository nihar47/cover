...
<div id="con-tabs">
          <ul>
            <li><span style="cursor:pointer;"><?php echo anchor('admin/list_admin','Administrator'); ?></span></li>
			 <li><span style="cursor:pointer;"><?php echo anchor('admin/admin_login','Login','id="sp_1" style="color:#364852;background:#ececec;"'); ?></span></li>
          </ul>
          <div id="text">
            <div id="1">
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
           ...
           <?php
					...
					echo form_open_multipart('admin/action_login',$attributes);
						?>
                          ...
                          <td valign="top"><div class="deals" style="display:block;" id="dig_it6">
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#888591">
                                  <tr class="alter">
								  <th width="2%">&nbsp;</th>
                                    <th width="10%" height="30"><strong>Username </strong></th>
									<th width="20%"><strong>Email</strong></th>
									<th width="10%"><strong>Admin Type</strong></th>
							  ...
							  <td align="center" valign="middle"><input type="checkbox" name="chk[]" id="chk" value="<?php echo $row->login_id;?>" /></td>
                                   ...
                                   <td align="center" valign="middle"><?php echo $row->email; ?></td>
                                    ...
                                    <td align="center" valign="middle"><?php echo date('d M,Y H:i:s',strtotime($row->login_date)); ?></td>
