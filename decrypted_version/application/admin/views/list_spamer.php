...
function getlimit(limit)

	{
...

		{
			...
			window.location.href='<?php echo site_url('spam/spamer/');?>'+'/'+limit;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('spam/search_list_spam');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('spam/spamer');?>';
...
<div id="con-tabs">
          ...
          <div id="text">
            ...
            <?php }  if($msg=='make_spam_permenant') { ?> <div align="center" style="color:#093; font-weight:bold;">Record has been make Permenant successfully.</div> 

            

            <?php }  if($msg=='success') { ?> <div align="center" style="color:#093; font-weight:bold;">New Record has been added successfully.</div> 
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
            ...
            <?php echo anchor('spam/spamer','<img src="'.base_url().'images/refresh.png" border="0" />'); ?>
            ...
            <td align="left" valign="middle">
				 ...
				 <?php
					...
					echo form_open('spam/search_list_spam/'.$limit,$attributes);
				  ?>
 ...
 <?php
					...
					echo form_open_multipart('spam/spamer_action',$attributes);
						?>    
            

       <!--  <form name="frm_listspamer" id="frm_listspamer" action="<?php // echo site_url('spam/spamer_action');?>" method="post">-->
        ...
        <?php echo anchor('spam/add_spammer','Add','style="text-decoration:none;color:#000000;font-size:14px; font-weight:bold;"');?>
        ...
        <a href="javascript:void(0)"  onclick="setaction('chk[]','delete', 'Are you sure, you want to delete selected spam report(s)?', 'frm_listspamer')" style="text-decoration:none;color:#000000;font-size:14px; font-weight:bold;" >Delete</a>
        ...
        <a href="javascript:void(0)"  onclick="setaction('chk[]','make_spam_permenant', 'Are you sure, you want to make Permenant spamer selected report(s)?', 'frm_listspamer')" style="text-decoration:none;color:#000000;font-size:14px; font-weight:bold;" >Make Permenant Spam</a>
                                  ...
                                  <tr class="alter">
								   ...
								   <th width="1%">&nbsp;</th>
                                    ...
                                    <th width="7%" height="30"><strong>Spam IP</strong></th>	
									 ...
									 <th width="7%" height="30"><strong>Start Date</strong></th>									

									<th width="10%"><strong>End Date</strong></th>

									<th width="7%"><strong>Permenant</strong></th>
								  ...
								  <tr onclick="<?php echo $fc; ?>(this);" class="<?php echo $cl; ?>">
								   ...
								   <td align="center" valign="middle"><input type="checkbox" name="chk[]" id="chk" value="<?php echo $row->spam_ip;?>" /></td>
                                    ...
                                    <td height="28"><?php echo $row->spam_ip; ?></td>
									 ...
									 <td height="28"><?php echo date($site_setting['date_format'],strtotime($row->start_date)); ?></td>

									

                                    <td height="28"><?php echo date($site_setting['date_format'],strtotime($row->end_date)); ?></td>
									...
									<?php if($row->permenant_spam=='1' || $row->permenant_spam==1) { ?>

									<img src="<?php echo base_url();?>images/spam_icon.png" border="0" width="24" height="24" />
