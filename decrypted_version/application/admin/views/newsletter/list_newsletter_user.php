...
function getlimit(limit)

	{
...

		{
			...
			window.location.href='<?php echo site_url('newsletter/list_newsletter_user/');?>'+'/'+limit;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('newsletter/search_newsletter_user');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('newsletter/list_newsletter_user');?>';
...
<div id="con-tabs">
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
            ...
            <td align="left" valign="middle">
				 ...
				 <?php
					...
					echo form_open('newsletter/search_newsletter_user/',$attributes);
				  ?>
	...
	echo form_open_multipart('newsletter/action_newsletter_user/',$attributes);
	?>
           ...
           <input type="hidden" name="action" id="action" />
			...
			<td width="10">&nbsp;</td>   
                ...
                <?php echo anchor('newsletter/add_newsletter_user','Add','style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"'); ?>
        ...
        <td align="right" valign="middle"><?php echo anchor('newsletter/export_newsletter_user/'.strtotime(date('H:i:s')),'Export CSV',' style="text-decoration:none;color:#6666CC;font-size:14px;font-weight:bold;"'); ?></td> 

   <td width="10">&nbsp;</td>   

    <td align="right" valign="middle"><?php echo anchor('newsletter/import_newsletter_user','Import CSV',' style="text-decoration:none;color:#6666CC;font-size:14px;font-weight:bold;"'); ?></td> 

   <?php //echo anchor('newsletter/import_newsletter_user','Import CSV', 'style="text-decoration:none;"'); ?>
						...
						<tr>
                          ...
                          <td valign="top"><div class="deals" style="display:block;" id="dig_it6">
							  ...
							  <td align="center" valign="middle"><input type="checkbox" name="chk[]" id="chk" value="<?php echo $row->newsletter_user_id;?>" /></td>
                                    ...
                                    <td height="28"><div class="pad-left"><?php if($row->user_name=='') { echo "N/A"; } else { echo $row->user_name; }?></div></td>
                                   ...
                                   <td align="center" valign="middle"><?php echo $row->email; ?></td>
                                    ...
                                    <td align="center" valign="middle"><?php echo date('d M,Y H:i:s',strtotime($row->user_date)); ?></td>

									

									<td height="28"><div class="pad-left" style="float:none; text-align:center;"><?php echo anchor('newsletter/edit_newsletter_user/'.$row->newsletter_user_id.'/'.$offset,'Edit','style="text-transform:capitalize;"'); ?></div></td>
