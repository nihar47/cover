<script type="text/javascript" language="javascript">
	...
	{
		var ans = confirm("Are you sure to delete language?");
		if(ans)
		{
			location.href = "<?php echo site_url('/language/delete_language'); ?>/"+id+"/"+offset;
		}else{
			return false;
		}
	}
                    ...
                    <td valign="top"><table width="100%" border="0" bgcolor="#FFFFFF">
                        <?php
							if($msg != "")
							{
								if($msg == "insert")
								{
									$msg = "New language inserted successfully";
								}
								if($msg == "update")
								{
                          ...
                          <td valign="top"><div class="deals" style="display:block;" id="dig_it6">
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#888591">
                                  <tr class="alter">
                                    <th height="30"><strong>Language Name</strong></th>
								  ...
								  <tr onclick="<?php echo $fc; ?>(this);" class="<?php echo $cl; ?>">
                                    <td height="28"><div class="pad-left"><?php echo $row->language_name; ?></div></td>
									...
									<td><div class="pad-left"><?php echo anchor('language/edit_language/'.$row->language_id.'/'.$offset,'Edit'); ?> / <a href="#" onclick="delete_rec('<?php echo $row->language_id; ?>','<?php echo $offset; ?>')">Delete</a></div></td>
                                  </tr>
								  <?php
								  			$i++;
										}
                                  ...
                                  <tr class="inner-tablebg">
                                    <td colspan="16" valign="top"><table  border="0" align="left">
                                        <tr class="inner-table">
										  ...
										  <td align="left" width="100"><?php echo anchor('language/add_language','Add', 'style="text-decoration:none;"'); ?>&nbsp;</td>
                                        </tr>
                                      </table></td>
                                  </tr>
                                </table>
