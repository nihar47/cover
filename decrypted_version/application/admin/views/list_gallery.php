<script type="text/javascript" language="javascript">
	...
	{
		var ans = confirm("Are you sure to delete gallery?");
		if(ans)
		{
		...
		function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo site_url('gallery/list_gallery');?>/'+limit;
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo site_url('gallery/search_list_gallery');?>/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
	...
	function gomain(x)
	{
		...
		if(x == 'all')
		{
			window.location.href= '<?php echo site_url('gallery/list_gallery');?>';
		}
	}
</script>
<div id="con-tabs">
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
            ...
            <?php
					...
					echo form_open_multipart('gallery/search_list_gallery/'.$limit,$attributes,'onSubmit="return chk_valid();"');
						?>
                ...
                <option value="all">All</option> 
                	<option value="name" <?php if($option=='name'){?> selected="selected"<?php }?>>Name</option>  
                </select>
        ...
        <?php echo anchor('gallery/add_gallery','Add', 'style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"'); ?>			
        </td>
                          ...
                          <td valign="top"><div class="deals" style="display:block;" id="dig_it6">
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#888591">
                                  <tr class="alter">
                                    <th height="30"><strong>Gallery Name</strong></th>
									 <th height="30"><strong>Gallery Image</strong></th>
								  ...
								  <tr onClick="<?php echo $fc; ?>(this);" class="<?php echo $cl; ?>">
                                    <td height="28"><div class="pad-left"><?php echo $row->gallery_name; ?></div></td>
                           
							    <td ><img src="<?php echo $base_image; ?>upload/gallery/<?php echo $row->gallery_image; ?>" alt=""  width="50" height="50" /></td>
                                    <td><div class="pad-left"><?php if($row->active=="1"){ echo "Active"; }else{ echo "Inactive"; } ?></div></td>
									<td><div class="pad-left"><?php echo anchor('gallery/edit_gallery/'.$row->gallery_id.'/'.$offset,'Edit'); ?> / <a href="#" onClick="delete_rec('<?php echo $row->gallery_id; ?>','<?php echo $offset; ?>')">Delete</a></div></td>
                                  </tr>
								  <?php
								  			$i++;
										}
