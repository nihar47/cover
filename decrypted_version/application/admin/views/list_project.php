...
function getlimit(limit)
{
	...
	{
		window.location.href='<?php echo site_url('project_category/list_project/');?>'+'/'+limit;
	}
...
function getsearchlimit(limit)
{
	...
	else
	{
		...
		window.location.href='<?php echo site_url('project_category/search_list_project');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...
<script type="text/javascript">
	function gomain(x)
	{
		switch(x){
			case 'all' :
						window.location.href= '<?php echo site_url('project_category/list_project');?>';
						break;
			case 'waiting':
...
<div id="con-tabs">
          <ul>
            <li><span style="cursor:pointer;"><?php echo anchor('project_category/list_project','Project List','id="sp_1" style="color:#364852;background:#ececec;"'); ?></span></li>
          </ul>
          <div id="text">
            <div id="1">
          ...
          <?php }  if($val=='cannot_delete_active') { ?> <div align="center" class="msgdisp" style="color:#FF0000;">You can not delete active project <span style="color:#0099FF;">"<?php echo $project_title_error;?>"</span>.</div> 
            ...
            <?php }if($msg=='no_delete') { ?><div align="center" class="msgdisp">You can not delete active Record(s).</div> 
            ...
            <?php }  if($msg=='inactive') { ?> <div align="center" class="msgdisp">Record(s) has been inactivated Successfully.</div>
             ...
             <?php }  if($msg=='declined') { ?> <div align="center" class="msgdisp">Record(s) has been declined Successfully.</div> 
            ...
            <?php } if($msg == "insert"){?> <div align="center" class="msgdisp">New Record(s) has been added Successfully.</div>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
            ...
            <td align="left" valign="middle">
			 ...
			 <?php
					...
					echo form_open('project_category/search_list_project/'.$limit,$attributes);
		 	 ?>

                
                <select name="option" id="option" style="width:125px;" onchange="gomain(this.value)">
                <option value="all">All</option> 
         		<option value="waiting" <?php if($option=='waiting'){?> selected="selected"<?php }?>>Waiting Approval</option> 
                 <option value="current" <?php if($option=='current'){?> selected="selected"<?php }?>>Current Projects</option> 
                 <option value="expired" <?php if($option=='expired'){?> selected="selected"<?php }?>>Expired Projects</option> 
                 <option value="successful" <?php if($option=='successful'){?> selected="selected"<?php }?>>Successful Projects</option> 
                 <option value="title" <?php if($option=='title'){?> selected="selected"<?php }?>>Project Title</option>                  <option value="user"  <?php if($option=='user'){?> selected="selected"<?php }?>>User</option>                   
                 <option value="ending"  <?php if($option=='ending'){?> selected="selected"<?php }?>>Ending Soon</option>
				</select>
		 ...
		 <?php
			...
			echo form_open('project_category/action_project/'.$limit, $attributes);
		 ?>
        ...
        <?php echo anchor('project_category/create','Add','style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"');?>
        </td>
        ...
        <div style="clear:both;"></div>
         ...
         <td><a href="<?php echo site_url('project_category/edit_project/'.$row['project_id']);?>"><img src="<?php echo base_url();?>images/edit.png" border="0" /></a></td>
                                  
         <td><a href="<?php echo site_url('project_category/updates/'.$row['project_id']);?>"><img src="<?php echo base_url();?>images/update.png" border="0" /></a></td>
         
         <td><a href="<?php echo site_url('project_category/perks/'.$row['project_id']);?>"><img src="<?php echo base_url();?>images/perk.png" border="0" /></a></td>     
         
                                     
         <td><a href="<?php echo site_url('project_category/donations/'.$row['project_id']);?>"><img src="<?php echo base_url();?>images/donation.png" border="0" /></a></td>
         
         
        <!-- <td><a href="<?php echo site_url('project_category/gallery/'.$row['project_id']);?>"><img src="<?php echo base_url();?>images/gallery.png" border="0" /></a></td>-->
                                    
                                    
         <td><a href="<?php echo site_url('project_category/comment/'.$row['project_id']);?>"><img src="<?php echo base_url();?>images/comment.png" border="0" /></a></td>
                                     
         <td><a href="<?php echo site_url('project_category/widgets/'.$row['project_id']);?>"><img src="<?php echo base_url();?>images/widgets.png" border="0" /></a></td>
