<script type="text/javascript" language="javascript">
...

	{
...

		{
			...
			location.href = "<?php echo site_url('country/delete_country/'); ?>"+"/"+id+"/"+offset;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('country/list_country/');?>'+'/'+limit;
		}
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('country/search_list_country');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('country/list_country');?>';
...
<div id="con-tabs">
        ...
        <?php echo anchor('country/add_country','Add', 'style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"'); ?>				
                              ...
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#888591">
                                  ...
                                  <tr class="alter">
                                    ...
                                    <th height="30"><strong>Country Name</strong></th>

									<!--<th><strong>Fips104</strong></th>

									<th><strong>Iso2</strong></th>

                                    <th><strong>Iso3</strong></th>
                                 ...
                                 <!--   <td><div class="pad-left"><?php //echo $row->fips; ?></div></td>

                                    <td><div class="pad-left"><?php //echo $row->iso2; ?></div></td>

                                    <td><div class="pad-left"><?php //echo $row->iso3; ?></div></td>

                                    <td><div class="pad-left"><?php //echo $row->ison; ?></div></td>                                

                                    <td><div class="pad-left"><?php //echo $row->internet; ?></div></td>

                                    <td><div class="pad-left"><?php //echo $row->capital; ?></div></td>

                                    <td><div class="pad-left"><?php //echo $row->map_ref; ?></div></td>

                                    <td><div class="pad-left"><?php //echo $row->singular; ?></div></td>

									<td><div class="pad-left"><?php //echo $row->plural; ?></div></td>

									<td><div class="pad-left"><?php ///echo $row->currency; ?></div></td>

									<td><div class="pad-left"><?php //echo $row->currency_code; ?></div></td>

									<td><div class="pad-left"><?php //echo $row->population; ?></div></td>
									...
									<td><div class="pad-left"><?php echo anchor('country/edit_country/'.$row->country_id.'/'.$offset,'Edit'); ?> / <a href="#" onclick="delete_rec('<?php echo $row->country_id; ?>','<?php echo $offset; ?>')">Delete</a></div></td>
