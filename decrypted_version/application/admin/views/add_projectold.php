...
<?php $CI =& get_instance(); $site = $CI->config->slash_item('base_url_site');
 ...
 $site_new = $CI->config->slash_item('base_url_site_image');  ?>
...
<?php }?>
		...
		<link type="text/css" href="<?php echo $site_new; ?>counter/css/ui-lightness/jquery-ui-1.8.18.custom.css" rel="stylesheet" />	
    <script type="text/javascript" src="<?php echo $site_new; ?>counter/js/jquery-1.7.1.min.js"></script>
		<script type="text/javascript" src="<?php echo $site_new; ?>counter/js/jquery-ui-1.8.18.custom.min.js"></script>
		<script type="text/javascript">
                       ...
                       <div id="step-navigation">
						  ...
						  <div id="step-navigation2">
						 	 ...
						 	 <ul>
                                ...
                                <li style="padding-left:85px;"><span>Project Details</span></li>
...
<!--------------Step-1---------------------->
  ...
  <select  name="user_id" id="user_id" class="btn_input_select" style="display:block;">
                            ...
                            <select  name="user_id" id="admin_user_id" class="btn_input_select" style="display:none;">
                ...
                <div id="step2" class="div" style="display:none;">
					...
					<div class="inner_content_two">
					       ...
					       <div style="width:300px; float:left">
					        ...
					        <div id="slider-range-max" style="width:205px;"></div>	<input type="text" id="total_days" name="total_days" style="border:0;background:none; width:20px;" value="" />&nbsp; DAYS
          ...
          <!--  <img src="<?php echo base_url(); ?>images/add.png" height="16" width="16" border="0" title="Add More" onclick="append_div2();" style="cursor:pointer;" />-->
			...
			<?php } ?>
					...
					<div  style="float: left;padding-left: 200px;margin-right: 20px;">
                    	...
                    	<input type="button" class="back_tab" id="back_tab" border="none"  title="back" onclick="display_div('step3');"/>
