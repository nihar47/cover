<script type="text/javascript" language="javascript">
...

	{
		...
		location.href = "<?php echo site_url('state/delete_state/'); ?>"+"/"+id+"/"+offset;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('state/list_state/');?>'+'/'+limit;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('state/search_list_state');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('state/list_state');?>';
...
<div id="con-tabs">
        ...
        <?php echo anchor('state/add_state','Add', 'style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"'); ?>				
                              ...
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#888591">
                                 ...
                                 <!--   <td><div class="pad-left"><?php //echo $row->code; ?></div></td>
                                    ...
                                    <td><div class="pad-left"><?php //echo $row->admcode; ?></div></td>-->

                                    <td><div class="pad-left"><?php if($row->active=="1"){ echo "Active"; }else{ echo "Inactive"; } ?></div></td>

									<td><div class="pad-left"><?php echo anchor('state/edit_state/'.$row->state_id.'/'.$offset,'Edit'); ?> / <a href="#" onclick="delete_rec('<?php echo $row->state_id; ?>','<?php echo $offset; ?>')">Delete</a></div></td>
								  ...
								  ?>   <tr style="background:none repeat scroll 0 0 #E4E5E5;"><td colspan="4"  height="28">No Record Found.</td></tr>
                                  <?php }?>                                                                
