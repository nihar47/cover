							...
							<div id="2" style="">
								  <div align="center">
									<div id="add-deal">
									  ...
									  ?>
										...
										<div class="fleft">
										  ...
										  <input type="hidden" name="name" id="name" value="<?php echo $name; ?>" onfocus="show_bg('name')" onblur="hide_bg('name')"/>
										  </span>
										</div>
										<div style="clear:both;"></div>
										
										<div class="fleft">
										  <label><?php echo $label; ?><span>&nbsp;</span></label>
									...
									<div class="fleft">
										  ...
										  <input type="hidden" name="label" id="label" value="<?php echo $label; ?>" onfocus="show_bg('label')" onblur="hide_bg('label')"/>
										  </span>
										</div>
										<div style="clear:both;"></div>
										...
										<div class="fleft">
										 ...
										 <textarea id="description" name="description" onfocus="show_bg('description')" onblur="hide_bg('description')" readonly="readonly"><?php echo $description;  ?></textarea>
										  </span>
										</div>
										<div style="clear:both;"></div>
										<div class="fleft">
