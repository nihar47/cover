<script type="text/javascript" language="javascript">
...

	{
...

		{
			...
			location.href = "<?php echo site_url('pages/delete_pages/'); ?>"+"/"+id+"/"+offset;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('pages/list_pages/');?>'+'/'+limit;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('pages/search_list_pages');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('pages/list_pages');?>';
...
<div id="con-tabs">
        ...
        <?php echo anchor('pages/add_pages','Add','style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"'); ?>			
                              ...
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#888591">
                                  ...
                                  <tr class="alter">
                                    ...
                                    <th height="30"><strong>Pages Title</strong></th>
                                  ...
                                  <!--  <th><strong>Header</strong></th>-->
                                   ...
                                   <th><strong>Footer</strong></th>                                  
									 ...
									 <th><strong>Abous Us links</strong></th>  

									<th><strong>Assistance links</strong></th>  
								  ...
								  <tr onclick="<?php echo $fc; ?>(this);" class="<?php echo $cl; ?>">
                                    ...
                                    <td height="28"><div class="pad-left"><?php echo $row->pages_title; ?></div></td>

                                  

                                    <!--<td align="center" valign="middle"><?php if($row->header_bar=='yes') { echo $row->header_bar; } ?></td>-->

                                   
									<td align="center" valign="middle"><?php  if($row->footer_bar=='yes') { echo $row->footer_bar; } ?></td>
                                   
                                    <td align="center" valign="middle"><?php  if($row->about_bar=='yes') { echo $row->about_bar; } ?></td>

									<td align="center" valign="middle"><?php  if($row->assistance_bar=='yes') { echo $row->assistance_bar; } ?></td>
									...
									<td><div class="pad-left"><?php echo anchor('pages/edit_pages/'.$row->pages_id.'/'.$offset,'Edit'); ?> / <a href="#" onclick="delete_rec('<?php echo $row->pages_id; ?>','<?php echo $offset; ?>')">Delete</a></div></td>
