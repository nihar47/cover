<script type="text/javascript" language="javascript">
...

	{
...

		{
			...
			location.href = "<?php echo site_url('testimonials/delete_testimonials/'); ?>"+"/"+id+"/"+offset;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('testimonials/list_testimonials/');?>'+'/'+limit;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('testimonials/search_list_testimonials');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('testimonials/list_testimonials');?>';
...
<div id="con-tabs">
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
            ...
            <td align="left" valign="middle">
			 ...
			 <?php
				...
				echo form_open('testimonials/search_list_testimonials/'.$limit,$attributes);
			  ?>
        ...
        <?php echo anchor('testimonials/add_testimonials','Add','style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"'); ?>			
                              ...
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#888591">
								  ...
								  <tr onclick="<?php echo $fc; ?>(this);" class="<?php echo $cl; ?>">
									...
									<td><div class="pad-left"><?php echo anchor('testimonials/edit_testimonials/'.$row->id.'/'.$offset,'Edit'); ?> / <a href="#" onclick="delete_rec('<?php echo $row->id; ?>','<?php echo $offset; ?>')">Delete</a></div></td>
