<script type="text/javascript" language="javascript">
...

	{
		...
		var ans = confirm("Are you sure to delete transaction?");

		if(ans)

		{

			location.href = "<?php echo site_url('transaction_type/delete_transaction/'); ?>"+"/"+id+"/"+offset;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('transaction_type/list_transaction/');?>'+'/'+limit;
...

	{
...

		{
			...
			window.location.href='<?php echo site_url('transaction_type/search_transaction_list');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
...
<script type="text/javascript">
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('transaction_type/list_transaction');?>';
...
<div id="con-tabs">
          ...
          <ul>
            ...
            <li><span style="cursor:pointer;"><?php echo anchor('transaction_type/list_transaction','Transactions','id="sp_1" style="color:#364852;background:#ececec;"'); ?></span></li>
          ...
          <div id="text">
            ...
            <td align="left" valign="middle">
				 ...
				 <?php
					...
					echo form_open('transaction_type/search_transaction_list/'.$limit,$attributes);
				  ?>
