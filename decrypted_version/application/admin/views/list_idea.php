<script type="text/javascript" language="javascript">
	...
	{
		var ans = confirm("Are you sure to delete idea?");
		if(ans)
		{
			location.href = "<?php echo site_url('idea/delete_idea/'); ?>"+"/"+id+"/"+offset;
...
function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo site_url('idea/list_idea/');?>'+'/'+limit;
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo site_url('idea/search_list_idea');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
	...
	function gomain(x)
	{
		...
		if(x == 'all')
		{
			window.location.href= '<?php echo site_url('idea/list_idea');?>';
...
<div id="con-tabs">
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
            ...
            <td align="left" valign="middle">
			 ...
			 <?php
				...
				echo form_open('idea/search_list_idea/'.$limit,$attributes);
			  ?>
      ...
      <?php echo anchor('idea/add_idea','Add', 'style="text-decoration:none;color:#000000;font-size:13px; font-weight:bold;"'); ?>			
        </td>
                          ...
                          <td valign="top"><div class="deals" style="display:block;" id="dig_it6">
                              <div id="last_login4" style="width:100%;overflow-x:auto;overflow-y:hidden;">
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#888591">
                                  <tr class="alter">
                                    <th height="30"><strong>Idea Title</strong></th>
									 <th height="30"><strong>Idea Image</strong></th>
									 <th height="30"><strong>Idea Description</strong></th>
								  ...
								  <tr onClick="<?php echo $fc; ?>(this);" class="<?php echo $cl; ?>">
                                    <td height="28"><div class="pad-left"><?php echo $row->idea_name; ?></div></td>
                           
							    <td ><img src="<?php echo $site; ?>upload/idea/<?php echo $row->idea_image; ?>" alt=""  width="50" height="50" /></td>
                                    <td><div class="pad-left"><?php if($row->active=="1"){ echo "Active"; }else{ echo "Inactive"; } ?></div></td>
									  <td height="28"><div class="pad-left"><?php echo $row->idea_description; ?></div></td>
									<td><div class="pad-left"><?php echo anchor('idea/edit_idea/'.$row->idea_id.'/'.$offset,'Edit'); ?> / <a href="#" onClick="delete_rec('<?php echo $row->idea_id; ?>','<?php echo $offset; ?>')">Delete</a></div></td>
                                  </tr>
								  <?php
								  			$i++;
										}
