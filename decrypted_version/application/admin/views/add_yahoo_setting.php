<div id="con-tabs">
		...
		$chk_message_setting=$this->home_model->get_rights('add_message_setting');
			...
			<li><span style="cursor:pointer;"><?php echo anchor('yahoo_setting/add_yahoo_setting','Yahoo','style="color:#364852;background:#ececec;"'); ?></span></li>    
         ...
         <li><span style="cursor:pointer;"><?php echo anchor('message_setting/add_message_setting','Messages'); ?></span> 	</li>
          ...
          <div id="text">
			...
			?>	
              ...
              <div class="fright"><a href="https://developer.apps.yahoo.com/dashboard/createKey.html" target="_blank">Create your application in Yahoo</a></div>
			  	  ...
			  	  <div class="fleft">
									  ...
									  <label>Yahoo Enabled  <span>&nbsp;</span></label>
