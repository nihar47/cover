...

{
...

	{
		...
		window.location.href='<?php echo site_url('project_category/project_report/');?>'+'/'+limit;
...

{
...

	{
		...
		window.location.href='<?php echo site_url('project_category/search_project_report');?>'+'/'+limit+'/'+'<?php echo $option.'/'.$keyword; ?>';
	}
...
<script type="text/javascript">
...

	{
...

		{
			...
			window.location.href= '<?php echo site_url('project_category/project_report');?>';
...
<div id="con-tabs">
          ...
          <ul>
            ...
            <li><span style="cursor:pointer;"><?php echo anchor('project_category/project_report','Project Report','id="sp_1" style="color:#364852;background:#ececec;"'); ?></span></li>
          ...
          <div id="text">
			...
			if($msg=='delete') { ?><div align="center" style="color:#093; font-weight:bold;">Project has been deleted successfully.</div> 

            

            <?php }  if($msg=='active') { ?> <div align="center" style="color:#093; font-weight:bold;">Project has been activated successfully.</div> 

            

            <?php }  if($msg=='inactive') { ?> <div align="center" style="color:#093; font-weight:bold;">Project has been inactivated successfully.</div>

			 

             <?php }  if($msg=='declined') { ?> <div align="center" style="color:#093; font-weight:bold;">Project has been declined successfully.</div> 

            

           

            <?php } if($msg=='feature') { ?> <div align="center" style="color:#093; font-weight:bold;">Project has been Featured successfully.</div> 

            

            <?php } if($msg=='not_feature') { ?> <div align="center" style="color:#093; font-weight:bold;">Project has been Remove From Featured successfully.</div> 
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%"  height="25" >
            ...
            <td align="left" valign="middle">
				 ...
				 <?php
					...
					echo form_open('project_category/search_project_report/'.$limit,$attributes);
				  ?>
                ...
                <select name="option" id="option" style="width:100px;" onchange="gomain(this.value)">
					...
					<option value="cat" <?php if($option=='cat'){?> selected="selected"<?php }?>>Categories</option>                   
          ...
          <span style="font-weight:bold;">RED: User doesn't verify their PayPal account is appearing in red color.</span>
