...
echo $sDf . SEC_AGO;
	...
	<?php 	$get_wallet_setting = wallet_setting();
	...
	<tr><td align="center" valign="top" height="30"><a href="<?php echo site_url('home/account');?>"  class="edit_setting"><?php echo MY_ACCOUNT; ?></a></td></tr>
     ...
     <tr><td align="center" valign="top" height="30"><a href="<?php echo site_url('inbox');?>"  class="edit_setting"><?php echo MY_INBOX.'('.get_total_unread_message_count($this->session->userdata('user_id')).')'; ?></a></td></tr>
    ...
    <tr><td align="left" valign="top"><a href="<?php echo site_url('user/activities/'.$this->session->userdata('user_id'));?>"  class="add_wallet_link"><?php echo 

'&nbsp;&nbsp;'.ACTIVITY; ?></a></td></tr>


      <tr><td align="left" valign="top"><a href="<?php echo site_url('invites');?>"  class="add_wallet_link"><?php echo '&nbsp;&nbsp;'.INVITES_FRIENDS; ?></a></td></tr>
      
      <?php 
		$affiliate_setting=affiliate_setting();		
		if($affiliate_setting->affiliate_enable==1) { 
		?>
       <tr><td align="left" valign="top"><a href="<?php echo site_url('affiliate');?>"  class="add_wallet_link"><?php echo '&nbsp;&nbsp;'.AFFILIATE; ?></a></td></tr>
      <?php } ?>
       ...
       <?php 
		...
		?>
       <tr><td align="left" valign="top"><a href="<?php echo site_url('stored_card');?>"  class="add_wallet_link"><?php echo '&nbsp;&nbsp;'.MY_CREDIT_CARD; ?></a></td></tr>
      <?php } ?>
