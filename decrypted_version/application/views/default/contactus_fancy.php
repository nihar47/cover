...
.fancy_main{
	...
	padding:10px 10px; /*height:461px;*/
}
.inner_content label {
    float: left;
    font-size: 12px;
}
.inner_content input, address { outline:none; border:1px solid #ccc; width:233px; height:20px; margin-bottom:0px; margin-top:0px; }
</style>
...
function form_validate(){
	...
	if(about.value==''){
		document.getElementById('about_err').innerHTML='<?php echo PLEASE_ENTER_QUESTIONS_ABOUT; ?>';
		about.focus();
		return false;
	}
          ...
          <h3 class="stitle"><?php echo HAVE_DIFFERENT_QUESTION; ?></h3>
			...
			?>
             ...
             <table border="0" cellpadding="0" cellspacing="0"  align="center" >
			  <tr><td  align="center" valign="middle" colspan="2" style="color:#FF0000; " height="20">
			  <?php if($error!='') { ?>
			     <?php echo $error; ?>
				<?php } ?></td></tr>
			  ...
			  <tr><td>&nbsp;</td><td ><div id="name_err" style="color:#f00; font-size:10px;"></div></td></tr>
			  ...
			  <tr><td>&nbsp;</td><td ><div id="email_err" style="color:#f00; font-size:10px;"></div></td></tr>
			  ...
			  <tr><td>&nbsp;</td><td ><div id="que_err" style="color:#f00; font-size:10px;"></div></td></tr>
			  ...
			  <tr><td>&nbsp;</td><td ><div id="msg_err" style="color:#f00; font-size:10px;"></div></td></tr>
			  ...
			  <tr><td>&nbsp;</td><td ><div id="about_err" style="color:#f00; font-size:10px;"></div></td></tr>
              ...
              <div id="post" >
              <input type="submit" name="contact" id="contact" value="<?php echo SEND; ?>" class="submit" onclick="return form_validate();" style="line-height:0px; height:auto;" />
