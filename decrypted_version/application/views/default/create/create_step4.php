...
/*$(function(){$('#birth_date').datepicker(
		...
		$(document).ready(function(){
			...
			var a = $("#birth_date").val();			 
			 var valNew = a.split('/');             
              var day =valNew[1];
              var month =valNew[0]-1;
              var year =valNew[2];
...
{	
   var fileInput =  document.getElementById("file_up");
	...
	if(file_size >= 2531323)
	 {	  
    if ( alert("Sorry, this file is too large. Please select a .jpg file that is less than 2 MB or try resizing it using a photo editor.")){
...
<section>
	...
	if($user_info['fb_uid'] != '' && $user_info['fb_uid'] !=0) {?>
	 ...
	 <?php } 
			 ...
			 <div id="test" class="gmap3" style="margin-left:137px;"></div>
		...
		<div id="state_div">
            ...
            <?php
                    ...
                    <input type="text" class="stext2" name="birth_date12" id="birth_date" placeholder="MM/DD/YYYY" style="width:233px;" value=" <?php echo date('m/d/Y',strtotime($birth_date));?>" readonly >
					...
					<label class="labe11" style="margin-bottom:5px;"><?php echo PHOTO_ID; ?></label>
				...
				<h3 class="step3h3">Social Networks</h3>
                <p class="arpare">
                Funding comes from a variety of sources — your audience, your friends and family, your broader social networks, and, if your project does well, strangers from around the web. It's up to you to build that momentum for your project. </p>
					<div class="clr"></div>
