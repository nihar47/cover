	...
	else
	{
     ...
     <script language="javascript" type="text/javascript">
						function append_perk()
						{
							...
							$("#metemp .dp").html('<input type="text" name="est_date[]" class="prjtitlediv" value="" title="fdfdF" />');
...
<section>
	<div id="page_we">
		...
		<div class="step_cont_top">
				<h2><?php echo EVERY_PROJECT_NEEDS_GREAT_IGIFT; ?></h2>
		...
		<div class="step_cont2">
            ...
            <?php if($error != "")
				...
				<div class="perk_cont" id="more2">
					...
					<tr>
						<td valign="top"><label class="perklabel" id="perk_num"><?php echo iGift; ?> #1</label></td>
						<td>
							<table class="pdtable" cellpadding="5" cellspacing="0">
							<tr>
							<td ><?php echo AMOUNT; ?></td>
							<td class="nrght"><input type="text"name="perk_amount[]" id="perk_amount"/></td>	</tr>
							
							<tr>
							<td ><?php echo DESCRIPTION; ?></td>
							<td  class="nrght"><textarea  class="" name="perk_description[]" ></textarea></td>
						</tr>
						<tr>
							<td ><?php echo EST_DELIVERY_DATE; ?></td>
							<td  class="nrght">
                            <div class="dp"><input type="text" name="est_date[]" class="prjtitlediv" value=""  /></div>
                           </td>
						</tr>
						...
						<tr>
							<td align="left" valign="top" ><img src="<?php echo base_url();?>/images/claimicon.png" style="float:left;" /> <?php echo CLAIMED; ?>
							 <div class="clr"></div>
							</td>
							<td  class="nrght" align="left" valign="top"><?php echo LIMIT; ?> #  <?php echo AVAILABLE; ?> <input type="checkbox" name="limit_avail[]" class="chklimit" /><br />
                            <input type="text" class="limittxt stext2" style="display:none;" name="perk_total[]"/>
							 <div class="clr"></div>
							</td>
						</tr>
				...
				<input type="hidden" name="set_perk" value="1" id="set_perk"/>
					...
					<tr>
						...
						<td>
							...
							<tr>
							<td ><?php echo AMOUNT; ?></td>
							<td class="nrght"><input type="text"  name="perk_amount[]" id="perk_amount" value="<?php echo $prk->perk_amount;?>"/></td>	</tr>
							
							<tr>
							<td ><?php echo DESCRIPTION; ?></td>
							<td  class="nrght"><textarea  class=""  name="perk_description[]" ><?php echo $prk->perk_description;?></textarea></td>
						</tr>
						<tr>
                        	<td ><?php echo EST_DELIVERY_DATE; ?></td>
							<td  class="nrght">
                            <div class="dp"><input type="text" name="est_date[]" class="prjtitlediv" value="<?php echo date('m/d/Y',strtotime($prk->perk_delivery_date));?>"/></div>
                           </td>
						</tr>

						<tr>
							<td align="left" valign="top"><img src="<?php echo base_url();?>/images/claimicon.png" style="float:left; margin-right:5px;" /><?php echo CLAIMED; ?>
							 <div class="clr"></div>
							</td>
							<td  class="nrght" align="left" valign="top"><?php echo LIMIT; ?> #  <?php echo AVAILABLE; ?> <input type="checkbox" name="limit_avail[]" class="chklimit" <?php if($prk->perk_total > 0){?>checked="checked" <?php }?>/><br />
                            <?php 
							if($prk->perk_total > 0)
							{
								$dis='block';
							...
							?>
                            <input type="text" class="limittxt stext2" style="display:<?php echo $dis;?>;" name="perk_total[]" value="<?php echo $prk->perk_total;?>"/>
							 <div class="clr"></div>
							</td>
						</tr>
                        <?php if($i>1){?>
	...
	<div id="page_we">
	 ...
	 <div class="perk_cont" id="more2" style="display:none;">
					...
					<tr>
						...
						<tr>
							<td valign="top" align="left";><img src="<?php echo base_url();?>/images/claimicon.png" style="float:left; margin-right:5px;" /> <?php echo CLAIMED; ?>
							 <div class="clr"></div>
							</td>
							<td  class="nrght"><?php echo LIMIT; ?> #  <?php echo AVAILABLE; ?> <input type="checkbox" name="limit_avail[]" class="chklimit" /><br />
                            <input type="text" class="limittxt stext2" style="display:none;" name="perk_total[]"/>
							 <div class="clr"></div>
							</td>
						</tr>
