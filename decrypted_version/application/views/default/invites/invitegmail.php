...
<div class="login_navl">
	...
	<span style="text-transform:capitalize;color:#2B5F94;font-size:17px;"><?php echo INVITE_GMAIL; ?></span>
...
?>
 ...
 <div class="inner_content" style=" margin-top:11px;padding:12px; ">
			...
			<h3 id="dropmenu2"><?php echo INVITE_GMAIL; ?> </h3>
	...
	$.get('<?php echo site_url('invites/send_invite');?>/'+res_email+'/'+res_name,function(html){
       ...
       <?php if(!$friend_list) { ?>
        ...
        <div class="invitegmail">
          <p><?php $var = sprintf(COULD_NOT_FIND_ANY_GMAIL_CONTACTS_CLICK_THE_BUTTON_TO_TEMPORARILY_CONNECT_GMAIL,$site_setting['site_name'],$site_setting['site_name']); echo $var;?>. </p><br />
          
          <p><?php echo WE_WILL_NEVER_SEND_ANY_EMAIL_MESSAGE_WITHOUT_ASKING;?></p>
          
          <div class="gmail_btn"><a href="<?php echo $gmail_connect;?>"><?php echo FIND_FRIENDS_FROM_GMAIL;?></a></div>
        </div>
        ...
        <!---left side-->
         <div class="lefthalf" style="clear:both; width:390px;">
          ...
          <div class="followimg"><a href="<?php echo site_url('invites/gmail');?>"><?php echo DISCONNECT; ?></a></div>
         ...
         <?php } } } ?>  
           ...
           <?php if($follow_list) {  
				...
				if($user_detail)
				{
					...
					$friend_user_profileimage=base_url().'upload/no_image.png';
