				...
				?> 
                         ...
                         id="unread"
                           ...
                           <span class="new_msg" ><?php echo "New"//NEW; ?></span>
                            <?php } ?></h1>
								<p style="float:right; width:auto;"><?php echo date($site_setting['date_format'],strtotime($sender_image['date_added']));?>(<?php echo getDuration($msg->date_added) ?>)</p><div class="clr"></div>
								<?php $prj=get_one_project($msg->project_id); ?>
								<p style="margin:5px 0;">Project: <?php echo $prj['project_title']; ?> </p><div class="clr"></div>
