						...
						document.getElementById('add_donate_amount').innerHTML = '<?php  echo anchor("wallet/add_wallet/".$cur_url,CLICK_HERE_TO_ADD_AMOUNT_TO_YOUR_WALLET); ?>' ;
							...
							if(cardtype=='')
								...
								document.getElementById('cannot_donate').style.display='none';
									...
									card_address=escape(card_address);
									//card_address=card_address.replace(/["',)(^#!{}*%'@&$]/g,' ');
									//urlencode()
      ...
      <div class="form-element-container">
        <table border="0" cellpadding="0" cellspacing="5">
          ...
          <tr>
            ...
            <td align="left" valign="top"><textarea class="btn_input" size="38" name="card_address" id="card_address" ><?php if($login_user['address']!='') { echo $login_user['address']; } else { echo $card_address; } ?>
              </textarea></td>
          </tr>
          <tr>
