...
<div class="section_contain" style="width:695px; float:left;">
...
if ($naira_currency->num_rows() > 0) {
	...
	$naira_currency_code= $naira_currency->currency_code;
}

*/

$one_project = get_one_project($id);
if($one_project['project_currency_symbol'] != ''){
	$currency_symbol = $one_project['project_currency_symbol'];
} else {
...

		{
...

			{
				...
				var rt = xmlhttp.responseText;
                                ...
                                set_wallet_details(rt);



				document.getElementById('amount').value=rt;

				document.getElementById('amount_hidden').value=rt;
				...
				/*var wallet_amt = '<?php //echo $total_wallet_amount; ?>';

				if(parseInt(rt)>parseInt(wallet_amt)
				{

                  document.getElementById('paypal_credit_payment_div').style.display='block';

				    document.getElementById('wallet_data').style.display='none';
			   ...
			   var testPattern=/^[0-9]*\.?[0-9]*$/;
				...
				if(testPattern.test(val)==false && val !='')

				 {
					...
					document.getElementById('amount_hidden').value = '';
...

				{
					...
					document.getElementById('amount_hidden').value = val;
				...
				//alert('ddd');
					...
					//document.getElementById('remain_amt').innerHTML = subt;
					...
					//document.getElementById("wallet_value").value = '4';
				...
				if(!isNaN(subt)){
						...
						//document.getElementById('paypal_credit_payment_div').style.display='none';

					        document.getElementById('wallet_data').style.display='block';
...
function return_set_wallet_details(){
				...
				var gateway = document.getElementById("gateway").value;//alert(gateway);
					...
					var perk = document.getElementById("perk_id").value;
					...
					var perkamt = document.getElementById('perk_amount').value;
						...
						if(gateway=='wallet'){ 
							...
							<?php if($wallet_setting->direct_donation_option!='1'){ ?>
								...
								if(!isNaN(subt)){
								   ...
								   // var ans=  confirm('Are you sure you want to make donation to <?php //echo $project['project_title'];?>');
									   ...
									   var url = document.getElementById("various1").href;//alert(url);
										...
										var wallet_value = document.getElementById("wallet_value").value;

										

										var currency_code = document.getElementById("currency_code").value;//alert(email);

										

										

									var newurl="<?php echo site_url('payment/add_fund_confirm/'.$project['project_id']); ?>/"+amount+"/"+perk+"/"+gateway+"/"+anonymous+"/"+currency_code+"/"+email+"/"+wallet_value;	
...
function hide_wallet_details(){
	...
	if(document.getElementById('gateway1').checked){
		...
		document.getElementById('gateway').value='interswitch';
...
function show_credit_div()

{

	$('#crecit_dis_div').slideDown();

	

	

	document.getElementById('gateway').value='credit';

}	



function show_paypal_div(val)
{
	var project_currency_symbol = '<?php echo $currency_symbol;?>';
  	//var naira_currency_symbol = '<?php //echo $naira_currency_symbol;?>';
	//var naira_currency_code= '<?php //echo $naira_currency_code;?>';
	var currency_symbol = '<?php echo $site_setting['currency_symbol'];?>';
	var currency_code = '<?php echo $site_setting['currency_code'];?>';
...
//	var naira_usd_amount = '<?php //echo $site_setting['naira_usd_amount'];?>';
	...
	if(val.value == 1){
		...
		if(project_currency_symbol == currency_symbol) {
	...
	$('#crecit_dis_div').slideUp();	

	document.getElementById('gateway').value=val.name;

	document.getElementById('wallet_value').value=val.value;
...
$(document).ready(function(){
	...
	$("#various1").colorbox({iframe:true, width:"700px", height:"250px"});
	 ...
	 $(".rad").change(function () {
		...
		var valueI = $('.rad:checked').val();

		

		$('#gateway').val('wallet');

		$('#wallet_value').val(valueI);
    ...
    <div class="inner_content_two">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" >
        ...
        <tr>
          ...
          <td align="left" valign="top" style="padding:5px 0px 0px 20px; font-size:14px;" id="currency_symbol"><?php echo $currency_symbol; ?></td>

          <td align="left" valign="top"><input type="text" class="textbx1" name="amount" id="amount" value="<?php echo $amount ;?>" onkeyup="set_wallet_details(this.value)" onchange="set_wallet_details(this.value)" />
		  
		  <input type="hidden" name="amount_hidden" id="amount_hidden" value="<?php echo $amount ;?>" />
        ...
        <?php  if($paypal->gateway_status!='1' && $wallet_setting->wallet_enable==1 && $credit_card_setting->credit_card_gateway_status!=1) {
        ...
        <tr>
          ...
          <td colspan="3" height="30"><p id="cannot_donate" style="color:#f00; font-size:11px; padding-bottom:8px; padding-left:55px; line-height:0px; display:<?php echo $dis; ?>">&nbsp;</p>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          ...
          <td align="left" valign="top" width="140" style="color:#434343 !important; font-size:15px; font-weight:bold;   text-transform:capitalize;"><input type="radio" name="selected_perk_id" id="selected_perk_id"  <?php if($project_perk_id==$perk['perk_id']) { ?> checked="checked"  <?php } ?> value="<?php echo $perk['perk_id']; ?>" onclick="assignamount(this.value)" />
            ...
            &nbsp;<?php echo set_currency($perk['perk_amount'],$id); ?>+</td>
        ...
        <tr>
          ...
          <td align="left" valign="top" style="border-bottom:1px solid #cccccc;"><div style="color:#114A75;margin:4px 0px 5px 0px;"><span style="font-weight:normal;color:#7DBF0E; font-size:13px; font-weight:bold;">
    ...
    <div class="inner_content_two">
      ...
      <?php /*if($amount > $total_wallet_amount)
...
?>
      ...
      <div class="form-element-container" id="paypal_credit_payment_div" style="display:block;">
        ...
        <table border="0" cellpadding="0" cellspacing="3" width="350">
  <?php
          ...
          <tr>
            ...
            <?php /*?><td align="left" valign="top"><input type="radio" class="rad" value="paypal" id="gateway_paypal" checked="checked" name="gateway2" onclick="show_paypal_div();"/></td>

            <td align="left" valign="top"><img src="<?php echo base_url(); ?>images/paypal.png" border="0" /></td><?php */?>

            <td align="left" valign="top">

            <input type="radio" name="wallet" class="rad" id="gateway_type<?php echo $k; ?>" value="<?php echo $row->id; ?>" onclick="show_paypal_div(this);" /></td>

            <td align="left" valign="top"><?php echo $row->name; ?></td>
 <td align="left" valign="top"></td>
           

            <!--<td align="left" valign="top"><input type="radio" value="credit" id="gateway_paypal" name="gateway2" onclick="show_credit_div();"/></td>

				<td align="left" valign="top"><img src="<?php //echo base_url(); ?>images/credit.png" border="0" /></td>	

-->

         <?php /*?><td align="left" valign="top"><input type="radio" class="rad" value="interswitch" id="interswitch" name="gateway2" /></td>

				<td align="left" valign="top"><?php echo $row->name; ?></td>	<?php */?>

          </tr> <tr>

            <td colspan="3" ><img src="<?php echo base_url(); ?>images/<?php echo $row->image; ?>" border="0" /></td>
   ...
   <?php
		...
		<?php //$remain = $total_wallet_amount-$amount;	?>		

      </div>

      <?php /*?><div id="crecit_dis_div" style="display:none;">
        ...
        <div class="form-element-container">
          ...
          <table border="0" cellpadding="0" cellspacing="5">
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label">&nbsp;<?php echo CREDIT_CARD_STORE_NUMBER; ?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" name="cardnumber" id="cardnumber" value="<?php echo $cardnumber; ?>"  class="textbx1" />
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_VERFICATION_NUMBER; ?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" name="cvv2Number" id="cvv2Number" value="<?php echo $cvv2Number; ?>"  class="textbx1" />
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_TYPE; ?> : *</label>

              </td>

              <td align="left" valign="top"><select name="cardtype" id="cardtype" class="textbx1" style="padding:0px;">
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_EXPIRY_DATE; ?> : *</label>

              </td>

              <td align="left" valign="top"><div style="float:left;">Month<br />

                  <select name="card_expiration_month" id="card_expiration_month" class="textbx1" style="padding:0px; width:42px;">
                ...
                <div style="float:left; padding:0px 0px 0px 10px;"> Year<br />
                  ...
                  <select name="card_expiration_year" id="card_expiration_year" class="textbx1" style="padding:0px; width:60px;">
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_FIRST_NAME; ?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" name="card_first_name" id="card_first_name" value="<?php if($login_user['user_name']!='') { echo $login_user['user_name']; } else { echo $card_first_name; } ?>"  class="textbx1" />
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_LAST_NAME; ?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" name="card_last_name" id="card_last_name" value="<?php if($login_user['last_name']!='') { echo $login_user['last_name']; } else { echo $card_last_name; } ?>"  class="textbx1" />
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_ADDRESS; ?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" class="textbx1" size="38" name="card_address" id="card_address" value="<?php if($login_user['address']!='') { echo $login_user['address']; } else { echo $card_address; } ?>" >
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_CITY ;?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" class="textbx1" size="25" name="card_city" id="card_city" value="<?php if($login_user['city']!='') { echo $login_user['city']; } else { echo $card_city; }?>" >
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_STATE ;?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" class="textbx1" size="15" name="card_state" id="card_state" value="<?php if($login_user['state']!='') { echo $login_user['state']; } else { echo $card_state; } ?>" >
            ...
            <tr>
              ...
              <td align="left" valign="middle"><label class="normal_label"><?php echo CREDIT_CARD_ZIPCODE ;?> : *</label>

              </td>

              <td align="left" valign="top"><input type="text" class="textbx1" size="17" name="card_zipcode" id="card_zipcode" value="<?php if($login_user['zip_code']!='') { echo $login_user['zip_code']; } else { echo $card_zipcode; } ?>" >
	  ...
	  <div id="wallet_data" style="display:block;"> </div>

     <?php /*?> <div id="wallet_data" style="display:<?php echo $dis2;?>;">
      ...
      <div class="form-element-container" style="margin-left:150px;">
        ...
        <input type="hidden" name="wallet_value" id="wallet_value" value="" />
