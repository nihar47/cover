<?php /*?><?php $get_ud=get_user_detail(get_authenticateUserID());
...
$("ul.accountul li").has("a#accsel").addClass("hi")
});
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <!--<ul class="loginul1" style="margin-left:0;">
        ...
        <li style="border-right:none; margin-right:0;"><a href="<?php echo site_url('help')?>"><?php echo HELP?></a>
        ...
        <div class="user_menu_div" id="user_menu_div" style="display: none;">
          <div class="user_menu_div_left">
            ...
            <ul>
              ...
              <li><?php echo anchor('wallet/my_wallet',WALLET); ?></li>
