	...
	<div id="page_we">
      <ul class="stepul">
		...
		<div class="step_cont2">
			...
			<h2 class="step1header" style="margin:20px 0 0 20px;"><?php echo PROJECT_GUIDELINES; ?></h2>
			<p class="step1des" style="margin:20px 0 0 20px;"><?php echo MAKE_SURE_YOU_HAVE; ?>:</p><div class="clr"></div>
				<ul class="ruleul">
				...
				<h2 class="step1header" style="margin:20px 0 0 20px;"><?php echo AFTER_YOU_SUBMIT; ?></h2>
			<p class="step1des" style="margin:20px 0 0 20px;"><?php echo ONCE_YOUVE_DONE_EVERYTHING_LISTED_ABOVE_AND_SUBMITTED_YOUR_PROJECT_FOR_REVIEW; ?>.</p><div class="clr"></div>
				<ul class="ruleul">
				...
				<div class="step2_right" style="padding:0;">
