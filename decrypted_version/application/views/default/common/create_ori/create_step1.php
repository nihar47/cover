...
<section>
	...
	<div id="page_we">
		...
		<div class="step_cont2">
			...
			<div id="not_valid_image" class="error" style="height:auto; margin:4px 0px 0px 0px; display:none;">
			...
			<label class="labe11"><?php echo PROJECT_IMAGE;?></label>
           	...
           	<div class="image_upload marl30 lt" style=" margin-top:15px;margin-left:24px; float:left;" id="picture_file_field_display"><input type="file" name="file1" id="file1"  class="project_picture" height="25px;" style="color:#FFFFFF; font-size:10px;"></div>
            ...
            <font style="font-size:12px;"><?php printf(MAX_CHAR,60); ?><input readonly type="text" name="countdown" value="60" class="normal_label" style="border:none; width:15px; margin:0px; float:none;"> <?php echo CHAR_LEFT; ?>.</font>
			</div>
			<div class="clr"></div>
			...
			<div style="float:right; margin-right:50px;">
			<font style="font-size:12px;"><?php printf(MAX_CHAR,135); ?><input readonly type="text" name="des_countdown" value="135" class="normal_label" style="border:none; width:25px; margin:0px; float:none;"> <?php echo CHAR_LEFT; ?>.</font></div><div class="clr"></div>
			
			<label class="labe11"><?php echo PROJECT_DURATION;?>*</label>
			<div class="radcont">
			
				<input type="radio" class="" name="duration" value="totalday" checked="checked" id="numdays" style="float:left;" /><p><?php echo NUMBER_OF_DAYS_50_DAYS; ?></p>
				<div style="float:left" id="shide">
					<div class="prjtitlediv" style="width:306px; margin:0" id="numdaysdiv">
				<input type="text" class="txt" name="endday" style="width:50px;" id="day" value="<?php echo $totaldays;?>" onkeyup="return end_dt();"><p class="par" id="par" style="line-height:22px;"><?php echo $site_setting['project_min_days']; ?>-<?php echo $site_setting['project_max_days']; ?> <?php echo DAYS ?>, <?php echo WE_RECOMMEND; ?> <?php echo $site_setting['project_max_days']; ?> <?php echo OR_LESS; ?></p>
				</div>
			</div>
<script>
$(document).ready(function(){
	$('#par').click(function(){
		$('#day').focus();
				...
				<div class="clr"></div>
				<input type="radio" class="" name="duration" id="st_date" value="totaldate" style="float:left; margin:10px 0 0 5px;"/><p style=" margin:10px 0 0 5px;"><?php echo END_ON_DATE_TIME; ?></p>
              	<input type="text" name="end_date" id="end_date" class="prjtitlediv" value="" style="display:none; width:205px; margin:5px 0 0px 56px;" />
			...
			<?php if($id == ''){?>
            	<div class="step2_right">
					...
					<p class="arpare"><?php echo REFER_TO_OUR; ?> &nbsp;</p><a href="<?php echo site_url('help'); ?>" class="arink"><?php echo PROJECT_HELP_CENTER; ?>.</a>
                ...
                if(is_file('upload/thumb/'.$project['image']))
					...
					if(is_file('upload/thumb/'.$project['image'])){
					?> <img src="<?php echo base_url().'upload/thumb/'.$img; ?>" alt="" id="ajaximage" class="project_img"/><?php
					}else{ ?>
			...
			<p class="prop"><?php echo BY; ?></p><?php echo anchor('user/profile/'.$user_info['user_id'],$user_info['user_name'].' '.$user_info['last_name'],'class="prjown"');?>
            <div id="project_card_summary"><p class="prop" style="height:60px;"><?php echo DESCRIPTION; ?></p></div><div class="clr"></div>
            <hr class="projhr">
            <div class="projectprg">
            	<div style="width:100%;" class="prjprocal"></div>
            </div><div class="one">0%</div>
            <ul class="projectdul">
            	<li style="width:112px;"><h2 class="currency"><?php echo $site_setting['currency_symbol']; ?></h2><p class="raised"><?php echo RAISED; ?></p></li>
                <li style="border:none;"><p style="float:right;" class="raised" ><?php echo DAYS_LEFT; ?></p><h2 style="float:right; margin-left:10px;" class="day"></h2></li>
            </ul>
        	</div>
            ...
            <?php }else{?>
                ...
                if(is_file('upload/thumb/'.$project['image']))
                 ...
                 <div id="project_card_category"><a class="category_name" href="#"><?php if($category_id){echo $this->startproject_model->get_project_getcategory($category_id);}else{echo 'Category';}?></a></div>
                <div id="project_card_title"><a class="category_title" href="#"><?php echo $project_title;?></a></div>
			<p class="prop"><?php echo BY; ?></p><?php echo anchor('user/profile/'.$user_info['user_id'],$user_info['user_name'].' '.$user_info['last_name'],'class="prjown"');?>
            <div id="project_card_summary"><p class="prop" style="height:70px !important;"><?php echo $project_summary;?></p></div><div class="clr"></div>
            <hr class="projhr">
            <div class="projectprg">
            	<div style="width:0%;" class="prjprocal"></div>
            </div><div class="one">0%</div>
            <ul class="projectdul">
            	<li style="width:112px;"><h2 class="currency"><?php echo $site_setting['currency_symbol']; ?></h2><p class="raised">0 <?php echo RAISED; ?></p></li>
                <li style="border:none;"><p style="float:right;" class="raised" id="dl"><?php echo $totaldays." ".DAYS_LEFT; ?></p><h2 style="float:right; margin-left:10px;" class="day"></h2></li>
            </ul>
        	</div>
	...
	<div id="page_we">
      ...
      <!-- <input type="button" class="stepbtn" value="Back" style="margin-left:346px;" />-->
        ...
        <input type="submit"  name="next" id="next" class="stepbtn" title="<?php echo NEXT; ?>" value="<?php echo NEXT; ?>" />
        
        </form>
		<!--<a href="#" class="deleteprj">Delete Project</a>-->
        <?php echo anchor('start/deleteproject_popup/'.$id,'Delete Project','id="iframe" class="deleteprj" title="Delete Project "'); ?> 
       <?php echo anchor('home','EXIT','class="exitp" title="Exit Project "');?>
	</div>
	</div>
