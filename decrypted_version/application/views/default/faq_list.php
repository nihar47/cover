...
<div class="faq_list_div">
  ...
  <div>
    <?php if($selected_faq_sub_category) {  
					 ...
					 foreach($selected_faq_sub_category as $sub) { ?>
    <h3 style="font-size:18px;text-transform:capitalize;" id="<?php echo $sub->faq_category_url_name; ?>"> <?php echo $sub->faq_category_name; ?> <a href="#"><img src="<?php echo base_url(); ?>images/top_arr.jpg" alt=""  style="float:right;position:relative;top:5px;"/></a></h3>
    <div class="clear"></div>
    <?php $faq_question=$this->help_model->get_category_question($sub->faq_category_id);
