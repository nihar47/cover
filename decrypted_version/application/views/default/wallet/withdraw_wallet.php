      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td align="center" ><div class="project_title_hd" style="padding-top:15px;" >
           <span style=" font-family: 'Oswald',sans-serif;color:#222222;font-size:26px; text-align:left" ><?php echo MANAGE_YOUR_ACCOUNT_BELOW; ?></span> </div></td>
...
?>
      <div class="inner_content withdraw_wallet">
        <h3 id="dropmenu2"> <span style="float:left;"><?php echo WITHDRAW_AMOUNT; ?></span> <span style="float:right; height:35px;  font-size:12px;">
          <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="right" valign="top"><?php echo anchor('wallet/my_wallet',MY_WALLET.'('.set_currency($total_wallet_amount).')');?></td>
              <td width="10">&nbsp;|&nbsp;</td>
