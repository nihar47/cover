  ...
  <div class="wrap930">
    ...
    <div class="login_navl">
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td align="center" ><div class="project_title_hd" style="padding-top:15px;" >
           <span style=" font-family: 'Oswald',sans-serif;color:#222222;font-size:26px; text-align:left"><?php echo MANAGE_WALLET_BELOW; ?></span> </div></td>
...
<div class="wallet-outer">
      <div class="inner_content" style=" margin-top:11px;padding:12px; ">
        <h3 id="dropmenu2"> <span style="float:left;"><?php echo MY_WITHDRAW; ?></span> <span style="float:right; height:35px;  font-size:12px;">
        ...
        <table border="0" align="left" cellpadding="0" cellspacing="1" width="100%" id="wallet_table">
          <tr>
            <th><?php echo AMOUNT; ?>(<?php echo $site_setting['currency_symbol']; ?>)</th>
          ...
          <tr class="<?php echo $cls; ?>">
            <td align="center" valign="middle" style="padding-right:8px;"><?php echo set_currency($rs->withdraw_amount);  ?></td>
            <td align="center" valign="middle" ><?php if($rs->withdraw_method=='bank') { echo NET_BANKING; } if($rs->withdraw_method=='check') { echo "Check"; } if($rs->withdraw_method=='gateway') { echo GATEWAY; } ?>
            </td>
          ...
          <tr class="even">
            <td colspan="8" height="35" align="center" valign="middle"><?php echo $page_link; ?></td>
          </tr>
          <?php  } } else { ?>
          <tr class="even">
