...
$(function() {
  $('.user_picture').on('change', function(event) {//alert("hi");
...
//	alert(name);
	...
	if(name==''){
		document.getElementById('img_err').innerHTML='<?php echo IMAGE_IS_REQUIRED; ?>';
		return false;
	}else{
...
<div class="wrap930" style="padding:10px 0px;">	
   ...
   echo form_open_multipart('home/image_upload/', $attributes);
?>
<input type="hidden" name="image_no" id="image_no" value="<?php echo $image_no; ?>" />
...
#fb-root div{ left:0; }
           ...
           <br />
			...
			<td>			
					...
					<tr><td> <div class="file_upload" style="float:left;" id="picture_file_field_display">
                   
                        	
                    <input type="file" name="file1" id="file1" class="user_picture" /></div><div><input type="text" name="file_name" id="file_name"readonly="readonly" style="border:none; background-color:#E3F0FD;"/></div>
		...
		<table border="0" width="200" cellpadding="0" cellspacing="0">
					<tr><td align="left" valign="top" >
                        ...
                        <div class="image_upload marl30 lt" id="picture_file_field_display1">
                        	
							<?php if($image_name!='' && is_file('upload/thumb/'.$image_name) ){  ?>
                        		
                                <img src="<?php echo base_url();?>upload/thumb/<?php echo $image_name; ?>" border="0" width="150" height="150" style="padding:2px; border:1px solid #E1E1E1;" id="media_image_img" />
							
							<?php }else{ 
									?><img src="<?php echo base_url();?>upload/thumb/no_man.gif" border="0" width="150" height="150" style="padding:2px; border:1px solid #E1E1E1;" id="media_image_img" /><?php
							 } ?>
...
function terms()
{
window.open('<?php echo 'terms_and_conditions';?>', TERMS_TXT ,'height=500,width=500,top=250,left=300,scrollbars=1');
}
</script>
</div>
