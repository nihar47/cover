<!--==========================footer=====================-->
<?php
	$query = $this->db->getwhere('twitter_setting',array('twitter_setting_id'=>'1'));
	if ($query->num_rows() > 0) {
	...
	$query = $this->db->getwhere('facebook_setting',array('facebook_setting_id'=>'1'));
	if ($query->num_rows() > 0) {
...
<div id="footer" style="background-color:#FFFFFF;opacity: 0.8;filter: alpha(opacity=60); border-top:1px solid #999999;">
	<div class="wrap930">	
		...
		<div class="right">
			<p id="footer_link" style="margin-top:16px;"><?php echo $footer_menu; ?></p>
...
if($project['p_google_code'] != ''){
	...
	$site=$this->home_model->select_site_setting();
