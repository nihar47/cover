		 ...
		 <?php //echo wordwrap(substr(strip_tags($rs['project_summary']),0,95),26, "\n",true);
            ...
            <p class="stats">
				<?php if($w=='0') { ?>
					...
					<span class="stleft"><?php echo $site_setting['currency_symbol']; ?>0.00 <br /><span class="spanf"><?php echo RAISED; ?></span></span>
				
				<?php } else { ?>
				<span class="stleft">
					<?php if($rs['amount_get']=='')	{
						echo $site_setting['currency_symbol']."0.00 <br /><span class='spanf'>".RAISED."</span>";
				
				}else{
								
				echo $site_setting['currency_symbol'].$rs['amount_get']." <br /><span class='spanf'>".RAISED."</span>"; 
