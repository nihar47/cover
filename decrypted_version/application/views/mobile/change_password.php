...
<div class="pad15">
    ...
    <?php  }  ?>
		...
		<input type="button" onClick="location.href='<?php echo base_url();?>home'" class="submbg2" name="login" id="login" value="<?php echo CANCEL; ?>"   />                        
        </div>

	</form>
        
    <?php echo $this->load->view('user_sidebar'); ?>    
