...
<td align="left" valign="middle" style="text-transform:capitalize; color:#000000;font-size:13px;"><?php echo $project['project_city'].', '.$project['project_state'] ; ?></td>
  ...
  ?>
	...
	<table align="center" width="602" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #B5D7FA;background:#E3F1FE;border-radius:3px;">
			...
			<div style="float:left;">
				...
				<!--	embed code-->							
				<?php  $query = $this->db->getwhere('project',array('project_id'=>$project['project_id']));
						$rs = $query->row();
