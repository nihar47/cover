            	...
            	<div class="block-inner">
            		<div class="content">
                       ...
                       <div id="step-navigation">
                            <ul>
                                <li id="1" class=""><a href="#" class="1"><span>&nbsp;</span></a></li>
                                <li id="2" class=""><a href="<?php echo site_url('start_project/create_step2/'.$id); ?>" ><span>&nbsp;</span></a></li>
                                <li id="3" class=""><a href="<?php echo site_url('start_project/create_step3/'.$id); ?>" ><span>&nbsp;</span></a></li>
                                <li id="4" class=""><a href="<?php echo site_url('start_project/create_step4/'.$id); ?>" ><span>&nbsp;</span></a></li>
                                <li id="5" class="first selected"><a href="<?php echo site_url('start_project/create_step5/'.$id); ?>" ><span>&nbsp;</span></a></li>
                            </ul>
