...
<div class="login_navl">
	...
	<span style="text-transform:capitalize;color:#2B5F94;font-size:17px;"><?php echo MANAGE_YOUR_ACCOUNT_BELOW; ?></span>
...
<div class="inner_content" style=" margin-top:11px;padding:12px; ">
		...
		<span style="float:left;"><?php echo WITHDRAW_AMOUNT; ?></span>
	...
	<?php if($error!='') { ?> <div style="clear:both; margin-top:20px;"></div><div align="left" class="error"> <?php echo $error; ?></div> <div style="clear:both; margin-top:20px;"></div><?php } ?>
	...
	<?PHP  printf(WALLET_WITHDRAW_HEADER_TEXT,$wallet_setting->wallet_donation_fees,set_currency($wallet_setting->wallet_minimum_amount)); ?></div>
...
<p>
<input type="radio" name="withdraw_method" id="withdraw_method" value="bank" <?php if($withdraw_method=='bank') { ?> checked="checked" <?php } ?> onClick="change_div_method(this.value)" /><?php echo BY_NET_BANKING; ?>&nbsp;&nbsp;&nbsp;

<input type="radio" name="withdraw_method" id="withdraw_method" value="check" <?php if($withdraw_method=='check') { ?> checked="checked" <?php } ?> onClick="change_div_method(this.value)" /><?php  echo BY_CHECK ;?>&nbsp;&nbsp;&nbsp;

<input type="radio" name="withdraw_method" id="withdraw_method" value="gateway" <?php if($withdraw_method=='gateway') { ?> checked="checked" <?php } ?> onClick="change_div_method(this.value)" /><?php echo BY_PAYMENT_GATEWAY; ?>
...
<div id="add_button"> <?php if($withdraw_id > 0){ } else{ ?> <input type="button" class="submit" style="cursor:pointer;" value="<?php echo SUBMIT; ?>" name="submit" id="submit" onclick="confirm_add();" /><?php } ?> </div>

</div>
<div style="clear:both;"></div>
<div id="con_button" <?php if($withdraw_id > 0){ echo 'style="display:block;"';  }else{ echo 'style="display:none;"'; } ?>>
	<h3 id="dropmenu2">
<span style="float:left;">Withdraw Details</span>
<?php
...
<tr><td align="left" valign="top" class="normal_label" width="125"><?php echo AMOUNT_REQUESTED; ?>(<?php echo $site_setting['currency_symbol']; ?>)</td>
<td>&nbsp;</td><td><span id="total_amount"><?php echo $amount; ?></span></td></tr>

<tr><td colspan="3">&nbsp;</td></tr>

<tr><td align="left" valign="top" class="normal_label" width="125"><?php echo TRANSACTION_FEES; ?>(<?php echo $site_setting['currency_symbol']; ?>)</td>
<td>&nbsp;</td><td><span id="fees_amount"><?php echo $fees_t; ?></span></td></tr>

<tr><td colspan="3">&nbsp;</td></tr>

<tr><td align="left" valign="top" class="normal_label" width="125"><?php echo YOU_WILL_GET; ?>(<?php echo $site_setting['currency_symbol']; ?>)</td>
<td>&nbsp;</td><td><span id="get_amount"><?php echo $get_u; ?></span></td></tr>

<tr><td colspan="3">&nbsp;</td></tr>
<tr><td align="left" valign="top"><input type="submit" class="submit" style="cursor:pointer;" value="<?php echo CONFIRM; ?>" name="submit" id="submit" /> </td>
	<td>&nbsp;</td>
	<td align="left" valign="top"><input type="button" class="submit" style="cursor:pointer;" value="<?php echo CANCEL; ?>"  onclick="go_to_add();" /> </td>
	</tr>
