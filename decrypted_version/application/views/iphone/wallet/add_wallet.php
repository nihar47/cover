...
<div class="inner_content" style=" margin-top:11px;padding:12px; ">
		...
		<span style="float:left;"><?php echo ADD_AMOUNT_TO_YOUR_WALLET; ?></span>
	...
	<div style="padding:25px 0px 25px 0px; clear:both;"><b style="color:#FF0000;"><?php echo NOTE;?> : </b>  <?php printf(WALLET_ADD_AMOUNT_NOTE,$wallet_setting->wallet_add_fees,set_currency($wallet_setting->wallet_minimum_amount)); ?>
...
<tr>
<td align="left" valign="top" class="normal_label" width="115"><?php echo ADD_AMOUNT; ?>(<?php  echo $site_setting['currency_symbol']; ?>)</td>
<td>&nbsp;</td>
<td align="left" valign="top"><input type="text" class="btn_input" name="credit" id="credit" value="<?php echo $credit ;?>" /><br />
<p style="color:#FF0000; padding-top:5px;"> <?php echo FOR_PAYPAL_USER_RETURN_TIP;?></p>
</td>
...
<p><input type="radio" name="gateway_type" id="gateway_type" value="<?php echo $row->id; ?>" <?php if($gateway_type==$row->id) { ?> checked="checked" <?php } ?> /><?php echo $row->name; ?></p>
	...
	<tr><td colspan="2">&nbsp;</td>
	<td align="left" valign="top" id="add_button">
    
    <input type="submit" class="submit" style="cursor:pointer;" value="<?php echo ADD; ?>" name="submit" id="submit" /> </td>
	</tr>
