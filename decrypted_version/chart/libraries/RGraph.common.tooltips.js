    ...
    */
    RGraph.Tooltip = function (obj, text, x, y, idx, e)
    {
        ...
        */
        ...
        tooltipObj.__event__                = obj.Get('chart.tooltips.event') || 'onmousemove';
        ...
        */
        ...
        tooltipObj.onmousemove     = function (e){if (e.button == 0) {e.stopPropagation();}}
		obj.canvas.addEventListener('mouseout', function() { 
														// RGraph.HideTooltip();
