...
class AdminUserController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{	
			...
			//Checking for user allready exist...	
			$users= AdminUser::model()->findByAttributes(array('username'=>$_POST['AdminUser']['username']));
			 if($users===null) {
				$_POST['AdminUser']['ip_address'] = $_SERVER['REMOTE_ADDR']; 
				...
				//$this->redirect(array('view','id'=>$model->id));
					...
					$model->attributes=$_POST['AdminUser'];
					$model->addError('username', "This user name allready exist, Please try again using another username.");
			}
		}
