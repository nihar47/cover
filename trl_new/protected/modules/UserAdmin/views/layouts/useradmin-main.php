...
<ul>
   ...
   <li class='has-sub'><a href='#'><span>WebSite</span></a>
      <ul>
       <li class='has-sub'><a href='<?php echo Yii::app()->request->baseUrl; ?>?r=UserAdmin/locations/admin'><span>Locations</span></a>
        </li>
    ...
    <li class='has-sub'><a href='#'><span>Accounts</span></a>
            <ul>
               <li><a href='<?php echo Yii::app()->request->baseUrl; ?>?r=business/admin'><span>Business Users</span></a></li>
                <li><a href='<?php echo Yii::app()->request->baseUrl; ?>?r=UserAdmin/user/admin'><span>Admin Users</span></a></li>
            </ul>
         </li>
