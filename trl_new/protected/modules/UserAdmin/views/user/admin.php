...
<h1 class="inner_title business"><?php echo Yii::t('UserAdminModule.admin','User management'); ?></h1>

<?php echo CHtml::link(
         Yii::t('UserAdminModule.admin','Create'), 
        array('create'),
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
                        ...
                        'header'=>CHtml::dropDownList('pageSize',$pageSize,array(10=>10,20=>20,50=>50,100=>100,200=>200),array(
