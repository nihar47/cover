...
<html lang="en">
  <head>
    ...
    <link href="<?php echo Yii::app()->getBaseUrl(true); ?>/css/scrollable.css" rel="stylesheet">
	<link href="<?php echo Yii::app()->getBaseUrl(true); ?>/css/jquery.rating.css" rel="stylesheet">
	...
	<script src="<?php echo Yii::app()->getBaseUrl(true); ?>/js/jquery.rating.js"></script>
 	<script src="<?php echo Yii::app()->getBaseUrl(true); ?>/js/jquery.MetaData.js"></script>	
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                      <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo Yii::app()->getBaseUrl(true); ?>/customer/rating<?php echo '?business_id='.$this->business_id; ?>"
                        <?php 
						if($this->curpage ==  '/customer/rating'){
							echo 'class="active"';
							}
						?> >Ratings</a></li>
                        <li><a href="<?php echo Yii::app()->getBaseUrl(true); ?>/customer/verify<?php echo '?business_id='.$this->business_id; ?>"
                         <?php 
						if($this->curpage ==  '/customer/verify' || $this->curpage ==  '/customer/ratebusiness'){
							echo 'class="active"';
							}
						?>
                         >Rate This Business</a></li>
                       
                                              
                        
                         <div class="social_link pull-right">
                        <li><b>Share :</b></li>
						<li><a href="https://www.facebook.com/sharer/sharer.php?s=100&images[0]=<?php echo Yii::app()->getBaseUrl(true).'/images/seal_logo.jpg'; ?>&t=<?php echo $this->business_Info->business_name; ?>&u=<?php echo urlencode(Yii::app()->getBaseUrl(true).'/customer/rating?business_id='.$this->business_id); ?>" target="_blank" class="facebook" title="Facebook">&nbsp;</a></li>
  ...
  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" class="google_plus" title="Google Plus">&nbsp;</a></li>
                        ...
                        <li><a href="<?php echo Yii::app()->getBaseUrl(true); ?>/backend.php?r=BusinessUser/default/rating" >Ratings</a></li>
                        <li><a href="<?php echo Yii::app()->getBaseUrl(true); ?>/backend.php?r=BusinessUser/default/manageratings" >Rate This Business</a></li>
                       </ul>
