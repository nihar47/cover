...
<?php if(Yii::app()->user->hasFlash('job_started_date')):?>
    <div class="errorMessage">
        <?php echo Yii::app()->user->getFlash('job_started_date'); ?>
    </div>
<?php endif; ?>

<?php if(Yii::app()->user->hasFlash('job_end_date')):?>
    <div class="errorMessage">
        <?php echo Yii::app()->user->getFlash('job_end_date'); ?>
    </div>
<?php endif; ?>
...
?>					
                  ...
                  <dd class="col-md-6">
				  <?php echo $form->dropDownList($model, 'frequency_type', $frequency_type_options ,array('class'=>'form-control','onchange' => 'return checkFrequencyId(this.value);')); ?>					
				  </dd> 
...
?>
		...
		<a href="<?php echo Yii::app()->getBaseUrl(true).'?r=Quotes/default/view&id='.$model->quote_id; ?>" class="btn btn-primary">Cancel</a> 
